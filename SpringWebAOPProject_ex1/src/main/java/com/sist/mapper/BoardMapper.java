...
public interface BoardMapper {
   // 1. 목록 
   @Select("SELECT no,subject,content,name,TO_CHAR(regdate,'YYYY-MM-DD') as dbday,hit,group_tab,num "
   ...
   // 7. 찾기 => 동적쿼리 
   // 8. 실시간 인기게시물 가져오기 AOP => 실시간 추적 (로그)
