		             ...
		             <tr>
		              ...
		              <td class="text-right">
		                <c:if test="${rvo.id==sessionScope.id }">
		                   ...
		                   <a href="../reply/reply_delete.do?no=${rvo.no }&fno=${vo.fno}" class="btn btn-xs btn-info">삭제</a>
		                </c:if>
		              </td>
		             </tr>
		             <tr>
		               <td colspan="2" class="text-left" valign="top">
		                 <pre style="white-space: pre-wrap; border: none; background: white;">${rvo.msg }</pre>
		               </td>
		             </tr>
		             <tr style="display: none;" id="u${rvo.no }" class="ups">
		                <td colspan="2">
		                   <form method="post" action="../reply/reply_insert.do">
		                     ...
		                     <button class="btn-info" style="width: 100px; height: 105px; float: left;">댓글수정</button>
		                   </form>
		                </td>
		             </tr>
		            </table>
		    ...
		    <tr>
		     <td>
		      <form method="post" action="../reply/reply_insert.do">
		         ...
		         <button class="btn-info" style="width: 100px; height: 105px; float: left;">댓글쓰기</button>
		      </form>
		     </td>
		    </tr>
		   </table>
