     ...
     <table class="table">
      <tr>
        <td>
         ...
         <input type=button value="입장" class="btn btn-sm" id="inputBtn">
         <input type=button value="퇴장" class="btn btn-sm" id="outputBtn">
        </td>
      </tr>
      <tr>
       <td>
      ...
      <tr>
        <td>
          ...
          <input type=button id="sendBtn" value="전송" class="btn-sm btn">
        </td>
      </tr>
     </table>
   </div>
